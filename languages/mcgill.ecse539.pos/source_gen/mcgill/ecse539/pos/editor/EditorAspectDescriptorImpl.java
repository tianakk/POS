...
public class EditorAspectDescriptorImpl extends EditorAspectDescriptorBase {
  ...
  public Collection<ConceptEditor> getDeclaredEditors(SAbstractConcept concept) {
    ...
    switch (conceptIndex.index(cncpt)) {
      case 0:
        return Collections.<ConceptEditor>singletonList(new BillTransactionConcept_Editor());
      case 1:
  ...
  public Collection<TransformationMenu> getDeclaredDefaultTransformationMenus(SAbstractConcept concept) {
    ...
    switch (conceptIndex1.index(cncpt)) {
      case 0:
        return Collections.<TransformationMenu>singletonList(new BillTransactionConcept_TransformationMenu());
      case 1:
        return Collections.<TransformationMenu>singletonList(new IngredientConcept_TransformationMenu());
      case 2:
        return Collections.<TransformationMenu>singletonList(new OrderItemConcept_TransformationMenu());
      default:
    }
  ...
  private static final ConceptSwitchIndex conceptIndex1 = new ConceptSwitchIndexBuilder().put(MetaIdFactory.conceptId(0x7d3ecb5c844f43f0L, 0x98db2b52b269987bL, 0x2bec263502412da6L), MetaIdFactory.conceptId(0x7d3ecb5c844f43f0L, 0x98db2b52b269987bL, 0x1e5a213b72756c61L), MetaIdFactory.conceptId(0x7d3ecb5c844f43f0L, 0x98db2b52b269987bL, 0x2bec263502412da4L)).seal();
